        ...
        <View style={[styles.item, { backgroundColor: "rgb(255,241,205)" }]}>
          ...
          >
            ...
            <View style={{ height: "100%", width: "40%" }}>
              <Image
                source={{
                  uri: "https://o.remove.bg/downloads/95cd254f-97b4-455f-833e-4bf265c7baf3/png-transparent-diagram-bar-chart-bar-miscellaneous-angle-text-removebg-preview.png",
                }}
        ...
        <View style={[styles.item, { backgroundColor: "rgb(253,213,222)" }]}>
          ...
          >
            ...
            <View style={{ height: "100%", width: "40%" }}>
              <Image
                source={{
                  uri: "https://o.remove.bg/downloads/9f3c7721-5cc5-45c6-9aa5-ff4e471a9e3b/233-2334056_heart-beat-rate-png-transparent-png-removebg-preview.png",
                }}
                style={{ height: "100%", width: "100%" }}
              />
            </View>
